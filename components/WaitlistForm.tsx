      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
        <div>
          <input
            ...
            className={`font-sans w-full h-11 md:h-12 px-4 border ${errors.email ? 'border-red-500' : 'border-neutral-600/50'
        ...
        <button
          type="submit"
          disabled={isSubmitting}
          className="font-sans w-full h-11 md:h-12 px-6 md:px-8 bg-primary-base text-neutral-900 font-semibold rounded-lg
          hover:bg-primary-dark transition-all duration-fast
          hover:-translate-y-0.5 shadow-sm hover:shadow-md
          disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none
          relative z-30 text-sm md:text-base"
        >
